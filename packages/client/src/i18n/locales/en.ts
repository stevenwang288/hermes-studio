...
export default {
  ...
  browser: {
    ...
    earmarkToggle: 'Toggle earmark annotation',
    importCookies: 'Import cookies from system browser', cookiesImported: 'Imported {count} cookies from Chrome', cookiesImportLocked: 'Chrome is running. Please close it and try again.', cookiesImportEmpty: 'No cookies found to import', cookiesImportError: 'Import failed: {error}',
    syncChrome: 'Sync Chrome Data', syncChromeRunning: 'Chrome is running. Please close Chrome and try again.', syncChromeNotFound: 'Chrome user data directory not found.', syncChromeError: 'Sync failed: {error}', syncChromeSuccess: 'Synced Chrome data ({count} cookies). Now using Chrome mirror profile.', syncChromeHint: 'Close Chrome, then click to copy login state to the embedded browser. Chrome can be used normally after sync.',
  ...
  theme: {
    ...
    builtInWallpapersHint: 'Click to apply a dark coding wallpaper. Click again to remove.',
    preview: 'Preview',
