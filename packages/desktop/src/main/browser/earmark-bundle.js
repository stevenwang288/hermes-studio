var Earmark=(()=>{var Ae=Object.defineProperty;var jt=Object.getOwnPropertyDescriptor;var Yt=Object.getOwnPropertyNames;var Ft=Object.prototype.hasOwnProperty;var qt=(e,t)=>{for(var n in t)Ae(e,n,{get:t[n],enumerable:!0})},Ht=(e,t,n,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of Yt(t))!Ft.call(e,r)&&r!==n&&Ae(e,r,{get:()=>t[r],enumerable:!(o=jt(t,r))||o.enumerable});return e};var Bt=e=>Ht(Ae({},"__esModule",{value:!0}),e);var Pn={};qt(Pn,{DEFAULT_ENDPOINT:()=>wt,SOURCE_ATTR:()=>Me,annotationToMarkdown:()=>Le,batchToMarkdown:()=>ke,createEarmark:()=>kt,destroyEarmark:()=>Rn,detectFramework:()=>J,domPath:()=>ye,extractElement:()=>ce,extractRegion:()=>we,extractSelection:()=>ve,getEarmark:()=>Nn,inspectElement:()=>D,pageContext:()=>z,uniqueSelector:()=>P});var Qe=`
:host {
  all: initial;
